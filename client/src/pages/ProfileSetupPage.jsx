      ...
      <section className="page-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input name="budgetMin" type="number" value={form.budgetMin} onChange={handleChange} required />
          </div>
          <div>
            <label>Budget Max</label>
            <input name="budgetMax" type="number" value={form.budgetMax} onChange={handleChange} required />
          </div>
          <div>
            <label>Move-in Date</label>
            <input name="moveInDate" type="date" value={form.moveInDate} onChange={handleChange} required />
          </div>
          <div>
            <label>Bio</label>
