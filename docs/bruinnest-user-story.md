...
**Dependency**: It depends on US\-1 as users have to have an account to set up profile\.
...
**Dependency**: It depends on US\-1, US\-2 as accounts and profiles must exist to browse\.
...
**Dependency**: It depends on US\-1, US\-2 and US\-3\.
...
2. Given a detail page for a user who has linked a Zillow unit \(see US\-6\), when the page renders, then the linked unit's address, rent, and photos are displayed\.
...
**User Role**: As a user who has found an apartment on Zillow
...
**Dependency**: It depends on US\-1 & 2 & 3 as an account and profile must exist to attach a unit\.

#### Acceptance Criteria

1. Given an authenticated user on the "Link Housing" page, when they search by address or neighborhood near UCLA, then the system queries the Zillow API and displays matching rental listings with address, rent, bedrooms, and photos\.
...
**Dependency**: It depends on US\-1 & 2 &3\.
...
**Dependency**: It depends on US\-1 & 2 & 5 & 7\.
...
**Dependency**: It depends on US\-1&2&4\.
...
**Dependency**: It depends on US\-1&2&5&6\.
...
**Dependency**: It depends on US\-1&2&7\.
...
**Dependency**: Depends on US\-1&2&6&7 \.
